	...
	return (
		<header className="border-border border-b bg-surface">
			<nav
				...
				className="mx-auto flex max-w-5xl items-center gap-5 px-4 py-3 sm:px-6"
			>
				<a
					href="/"
					aria-label="Home"
				...
				<a
					href="/feed.xml"
					aria-label="RSS feed"
					className="ml-auto font-mono text-subtle text-xs no-underline transition-colors hover:text-accent"
				>
					RSS
				</a>
			</nav>
