...
ask Claude to make them for you. I did end up writing
[a dedicated hooks post](/claude-hooks.html) with three real examples: blocking
destructive commands, protecting sensitive files, and building an audit log.
